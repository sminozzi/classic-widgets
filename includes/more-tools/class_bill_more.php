<?php // namespace restore_classic_widgets_BillMore {
if (!defined("ABSPATH")) {
    exit();
...
add_action("init", "restore_classic_widgets_bill_more");
// >>>>>>>>>>>>>>>>>>>>>>>
*/
class restore_classic_widgets_Bill_Minozzi_Add_Ajax_Url {
...
$restore_classic_widgets_bill_minozzi_add_ajax_url = new restore_classic_widgets_Bill_Minozzi_Add_Ajax_Url();
class restore_classic_widgets_Bill_show_more_plugins
{
    //
    public function __construct()
    {
    ...
    //    add_action("wp_ajax_bill_install_plugin2", "bill_install_plugin2");
        // add_action('wp_ajax_bill_install_plugin2', array('\restore_classic_widgets_BillMore\Bill_show_more_plugins', 'bill_install_plugin2'));
       ...
       // work add_action('wp_ajax_bill_install_plugin2', '\restore_classic_widgets_BillMore\bill_install_plugin2');
    }
...
$show_more_plugins = new restore_classic_widgets_Bill_show_more_plugins();
// } // end namespace
class restore_classic_widgets_PluginInstaller {
    public function __construct() {
    ...
    $plugin = $slug;
    $skin = new \restore_classic_widgets_bill_install_QuietSkin(["api" => $api]);
...
$plugin_installer = new restore_classic_widgets_PluginInstaller();
//$plugin_installer->install_plugin();
require_once ABSPATH . "wp-admin/includes/plugin-install.php";
require_once ABSPATH . "wp-admin/includes/class-wp-upgrader.php";
class restore_classic_widgets_bill_install_QuietSkin extends \WP_Upgrader_Skin
{
    public function __construct()
    {
        parent::__construct();
...
$quiet_skin = new restore_classic_widgets_bill_install_QuietSkin();
